      ...
      <div className="bg-[#14171d] border border-white/10 p-4 rounded-2xl flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 shadow-lg">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="px-3 py-2.5 rounded-xl bg-[#090a0d] border border-white/10 text-xs text-neutral-300 focus:outline-none focus:border-[#CC1F1F] transition-colors"
          >
                  ...
                  <tr key={prod._id} className="hover:bg-white/[0.02] transition-colors group">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="max-w-[220px]">
                          <Link
                            ...
                            className="font-semibold text-white hover:text-[#CC1F1F] transition-colors truncate block text-xs"
                          >
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        {prod.isFeatured && (
                          <span className="px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider bg-[#CC1F1F]/15 text-[#CC1F1F] border border-[#CC1F1F]/30">
                            Featured
                          </span>
                        )}
                        {prod.isNewArrival && (
                    ...
                    <td className="py-3 px-4 text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        <button
                          ...
                          className="p-1.5 rounded-lg text-neutral-400 hover:text-[#CC1F1F] hover:bg-[#CC1F1F]/10 transition-colors"
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-lg text-neutral-400 hover:text-[#CC1F1F] hover:bg-[#CC1F1F]/10 transition-colors disabled:opacity-50"
                          title="Duplicate luminaire as draft"
                        >
                          {duplicatingId === prod._id ? (
                            <Loader2 className="w-3.5 h-3.5 animate-spin text-[#CC1F1F]" />
                          ) : (
