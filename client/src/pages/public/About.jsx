...
export const About = () => {
  ...
  useEffect(() => {
    document.title = 'Company Profile & Craftsmanship | LightHut Decorative Solutions';
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-b border-white/10 mb-16">
        <div className="max-w-3xl">
          ...
          <p className="text-base sm:text-lg text-neutral-300 mt-4 leading-relaxed font-light">
            Founded with a passion for spatial elegance and optical precision, LightHut Decorative Solutions manufactures and supplies premier luminaires for high-profile architects, interior designers, and luxury developers worldwide.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <span className="text-xs uppercase tracking-luxury text-[#c5a880] font-semibold block">
              Pioneering Heritage
            </span>
            ...
            <div className="pt-4 grid grid-cols-2 gap-6 border-t border-white/10">
              <div>
                <span className="font-serif-luxury text-3xl font-bold text-[#c5a880] block">25+</span>
                <span className="text-xs text-neutral-400 mt-1 block">Years of Specialized Manufacturing</span>
              </div>
              <div>
                <span className="font-serif-luxury text-3xl font-bold text-[#c5a880] block">1,200+</span>
        ...
        <div className="pt-12 border-t border-white/10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="text-3xl font-serif-luxury font-bold text-white">
              The Four Pillars of LightHut Luminaires
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="p-6 rounded-2xl bg-[#14171d] border border-white/10 shadow-xl space-y-3">
              <Zap className="w-8 h-8 text-[#c5a880]" />
        ...
        {/* CTA Banner */}
        <div className="p-10 rounded-3xl bg-gradient-to-r from-[#181b22] to-[#111318] border border-[#c5a880]/30 text-center flex flex-col sm:flex-row items-center justify-between gap-6 shadow-2xl">
