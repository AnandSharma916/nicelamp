...
export const Categories = () => {
  ...
  useEffect(() => {
    document.title = 'Lighting Categories | LightHut Decorative Solutions';
                ...
                >
                  ...
                  <div className="absolute inset-0 p-6 flex flex-col justify-between">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-mono text-[#c5a880] bg-black/60 backdrop-blur-md px-2.5 py-1 rounded-md border border-white/10">
                    ...
                    <div>
                      <h3 className="text-2xl font-serif-luxury text-white font-bold group-hover:text-[#c5a880] transition-colors">
                        {category.name}
                      </h3>
